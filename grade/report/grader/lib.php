...
class grade_report_grader extends grade_report {
    ...
    public function get_left_rows($displayaverages) {
        ...
        $studentheader->text = $arrows['studentname']. " (Numéro étudiant)";
        ...
        foreach ($this->users as $userid => $user) {
            ...
            $usercell->text .= html_writer::link(new moodle_url('/user/view.php', array('id' => $user->id, 'course' => $this->course->id)), $fullname. " (".$user->idnumber.")", array(
                'class' => 'username',
