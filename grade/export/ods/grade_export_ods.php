...
class grade_export_ods extends grade_export {
	...
	$this->anonymous = $formdata->export_anonymous; //BRICE
    }
	...
	if ($this->anonymous) {
		$profilefields = array();
		$idcolumn = new stdClass();
		$idcolumn->customid = 0;
		$idcolumn->shortname = 'id';
		$idcolumn->fullname = 'Identifiant Moodle';
		$profilefields[] = $idcolumn;
	}
	//FIN
