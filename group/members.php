...
<div id="addmembersform">
    ...
    <tr>
        <td>
            <a href='emptygroup.php?group=<?php echo $groupid; ?>&empty=1'><button>Vider le groupe</button></a><br>(les étudiants restent inscrits au cours)
        </td>        
        <td>
            <a href='emptygroup.php?group=<?php echo $groupid; ?>&unen=<?php echo $unenrolverif; ?>'><button>Désinscrire du cours</button></a><br>tous les membres de ce groupe (même les enseignants)<br><span style='color:red;fontweight:bold'>ATTENTION : irréversible</span>
        </td>
    </tr>
    </table>
