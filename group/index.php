...
echo '<table><tr><form id="groupeditform" action="index.php" method="post"><td>'."\n";
echo '<div>'."\n";
...
echo '<br><p style="text-align:center"><a href="copygroup.php?id='.$COURSE->id.'"><button>Importer des groupes UCP</button></a></p><br>';
echo $OUTPUT->footer();
