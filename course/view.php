...
//  Display the course home page.
    ...
    //Sur la page des tutoriels pour enseignants, lien vers la création d'un ticket :
    if ($id == 11) { //Tutoriels pour les enseignants
        echo "<p>Si vous ne trouvez pas de solution à votre problème dans les tutoriels ci-dessous, vous pouvez recevoir l'aide du SEFIAP <a href='https://helpdesk.u-cergy.fr/stylesheets/ticketAdd.faces' target='_blank'>en créant un ticket</a>.</p>";
    }
