...
class block_search_course extends block_base {
    ...
    public function get_content() {
        ...
        $this->content->text  = '<form action="'.$CFG->wwwroot.'/course/search.php" style="text-align:center">';
        $this->content->text  .= '<input id="searchform_search" name="search" type="text" size="40" />&nbsp;&nbsp;';
        $this->content->text  .= '<button id="searchform_button" type="submit" title="Search">'.$strgo.'</button><br />';
//        $this->content->text  .= get_string('advanced', 'block_search_course')."<br>";
