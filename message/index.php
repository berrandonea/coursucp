...
// BRICE.
if ($user2id != 3031) { // 3031 : Signalement abus.
    redirect("$CFG->wwwroot/local/mail/view.php?t=inbox");
}
...
//BRICE ligne originale effacer. Regarder sur un autre Moodle
    $PAGE->set_title("Signaler un abus"); //BRICE
} else {
    $PAGE->set_title("{$SITE->shortname}: $strmessages");
}
//BRICE ligne originale effacer. Regarder sur un autre Moodle
$PAGE->set_heading("Signaler un abus"); //BRICE
...
echo "<h3 style='color:red'>ATTENTION : Ce service vous permet de signaler des cas de harcèlement ou d'usage indélicat de la plateforme par d'autres personnes. Pour toute autre question, merci de vous adresser à votre enseignant(e).</h3>"; //BRICE
