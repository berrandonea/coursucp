...
<div id="page" class="main-content">
    <div id="page-content">
        <?php if($hassubtitle){?>
            <!-- <h2 class = "page-subtitle"><?php echo $PAGE->heading;?></h2>  Commenté par BRICE, et h3 remplaçé par h2 -->
        <?php } 
        $hasnavbar = 1; //BRICE Mettre 0 pour supprimer la barre de navigation
        if ($hasnavbar) { ?>             
