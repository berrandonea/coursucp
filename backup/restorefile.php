...
$transfer = optional_param('transfer', 0, PARAM_INT); //Brice : pour le tranfert de cours depuis ENP15
...
//BRICE : pour transfert depuis ENP15
if ($transfer > 0) {
    echo "<p style='color:green;font-weight:bold'>Glissez ici le fichier que vous avez téléchargé sur l'ancienne plateforme.</p>";
}
//FIN
