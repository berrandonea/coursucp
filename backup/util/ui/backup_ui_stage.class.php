...
class backup_ui_stage_initial extends backup_ui_stage {
     ...
     */
    public function process_original(base_moodleform $m = null) {

        $form = $this->initialise_stage_form_original();
     ...
     */
    protected function initialise_stage_form_original() {
        global $PAGE;
        if ($this->stageform === null) {
            ...
            $form->add_settings_original($add_settings); //BRICE
            // Add dependencies.
...
class backup_ui_stage_schema extends backup_ui_stage {
     ...
     * @return int The number of changes the user made
     */
    public function process_original(base_moodleform $form = null) {
        $form = $this->initialise_stage_form();
        // Check it wasn't cancelled.
        if ($form->is_cancelled()) {
            $this->ui->cancel_process();
