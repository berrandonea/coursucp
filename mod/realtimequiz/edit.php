...
function realtimequiz_list_questions($quizid, $cm) {
    ...
    foreach ($questions as $question) {
        ...
        $answertext = format_text($answer->answertext, FORMAT_HTML);
        $qtext = format_text(format_string($question->questiontext), FORMAT_HTML); //BRICE
        //BRICE $qtext = format_string($question->questiontext);
