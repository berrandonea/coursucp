...
class mod_workshop_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        //SALMA MODIFY BUG NOTE => Note du travail pour réussir
        $mform->addRule('submissiongradepass', null, 'float', null, 'client');
        ...
        //SALMA MODIFY BUG NOTE => Note de l'évaluation pour réussir
        $mform->addRule('gradinggradepass', null, 'float', null, 'client');
            ...
            if (!empty($gradeitems)) {
                foreach ($gradeitems as $gradeitem) {
                    ...
                    if ($gradeitem->itemnumber == 0) {
                        ...
                        //SALMA bug note
                        $submissiongradepass->setValue(number_format($gradeitem->gradepass, 2));
                        ...
                        //SALMA bug note 
                        $gradinggradepass->setValue(number_format($gradeitem->gradepass,2));                        
