...
//if ($bigbluebuttonbn->sefiap == 2) { //BRICE
...
if (!empty($bigbluebuttonbn->openingtime) && $now < $bigbluebuttonbn->openingtime ) {
   ...
   /* //BRICE
	...
	echo "<h2>Cette webconférence n'a pas encore reçu l'accord du SEFIAP.</h2>";
	echo "<span style='text-align:justify'>ATTENTION: Votre webconférence ne sera accessible qu'après avoir reçu l'accord du SEFIAP. Une demande a automatiquement été envoyée au SEFIAP quand vous avez créé la webconférence."
		." L'objectif est d'éviter de surcharger le serveur avec plusieurs webconférences simultanées. Si nécessaire, nous prendrons contact avec vous pour convenir d'une autre date.</span><br><br>";
}
//FIN*/
//
// Finish the page
