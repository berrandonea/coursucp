...
class edit_renderer extends \plugin_renderer_base {
    ...
    protected function start_section($structure, $section) {
        ...
        $output .= html_writer::start_div('section-heading', array("style" => "font-size:12"));
    ...
    public function add_menu_actions(structure $structure, $page, \moodle_url $pageurl,
        ...
        $trigger = html_writer::tag('span', "Ajouter une question", array('class' => 'add-menu')); //BRICE
    ...
    public function edit_menu_actions(structure $structure, $page,
        ...
        $actions['addaquestion'] = new \action_menu_link_secondary(
            ...
            "Nouvelle", array('class' => 'cm-edit-action addquestion', 'data-action' => 'addquestion') //BRICE
        );
        ...
        $actions['questionbank'] = new \action_menu_link_secondary($pageurl, $icon, "De la banque", $attributes); //BRICE
        ...
        $actions['addarandomquestion'] = new \action_menu_link_secondary($url, $icon, "Aléatoire", $attributes); //BRICE
