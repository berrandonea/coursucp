...
function stats_get_report_options($courseid,$mode) {
    ...
    $reportoptions[14] = "Suivi détaillé du cours";
     $reportoptions[15] = "Suivi global d'un étudiant";
     $reportoptions[0] = "Nombre d'actions par étudiant";
    $reportoptions[10] = "Actions d'un étudiant dans ce cours";
    $reportoptions[6] = "Liste des étudiants";
    $reportoptions[11] = "Nombres de caractères tapés (forums et chats)";
    $reportoptions[12] = "Temps passé sur ce cours";
    
  //  $reportoptions[14] = "Liste des étudiants";
     
    //$reportoptions[15] = "Heures de remise des devoirs/ateliers/quiz";
    $reportoptions[7] = "Heures de remise des devoirs/ateliers/quiz";
    //$reportoptions[16] = "Dépendances entre activités"; 
    
    //$reportoptions[13] = "Parcours des étudiants";
    
     
    //SALMA retirer les rapports messages role
     unset($reportoptions[53]);
     unset($reportoptions[55]);
     unset($reportoptions[56]);
     unset($reportoptions[2]);
     unset($reportoptions[3]);
     unset($reportoptions[4]);
   // print_object($reportoptions);
