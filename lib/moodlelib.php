...
//BRICE
	if ($identifier == 'pluginname' && $component == 'enrol_self') {
		$string['en'] = 'Self-enrolment by key';
		$string['fr'] = 'Auto-inscription par clé';
	        return $string[current_language()];
	}
	if ($identifier == 'pluginname' && $component == 'report_roster') {
                $string['en'] = 'Roster';
                $string['fr'] = 'Trombinoscope';
                return $string[current_language()];
        }
	if ($identifier == 'enrolmentinstances' && $component == 'enrol') {
		$string['en'] = 'Methods used in this course';
		$string['fr'] = 'Méthodes utilisées dans ce cours';
		return $string[current_language()];
	}
	if ($identifier == 'mass_enroll' && $component == 'local_mass_enroll') {
		$string['en'] = 'CSV file enrolment';
		$string['fr'] = 'Inscription par fichier CSV';
		return $string[current_language()];
	}
//FIN
