...
class filter_toc extends moodle_text_filter {
    ...
    public function filter($text, array $options = array()) {
      ...
      if (!isset($PAGE->nb_ancre_toc)) {
          //$PAGE->nb_ancre_toc = 0;
          //$PAGE->toc_summary = "";
      }
      
      
      //echo "$PAGE->pagelayout<br><br>";
      ...
      /*var_dump($num_entries);
      echo "$num_entries<br><br>";*/
      
      if (!$num_entries) return $text;
      ...
      $this->toc_text = '<div class="toc"><a name="toc" id="toc" />' . $this->toc_text .'</div>';
      ...
      if ($insert_at) {
        ...
        //echo "<br><pre>$this->toc_text</pre><br>";  
