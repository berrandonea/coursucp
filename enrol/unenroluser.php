...
//BRICE
$courseidnumberparts = explode('-', $course->idnumber);
if ($courseidnumberparts[0] == 'PERSO') {
    if ($courseidnumberparts[1] == $user->id) {
        echo $OUTPUT->header();
        echo "Il n'est pas possible de désinscrire un utilisateur de son propre espace personnel.";
        echo $OUTPUT->footer();
        exit;
    }
}
