...
class user_editadvanced_form extends moodleform {
    ...
    public function definition() {
        ...
        //SALMA remplace text => static
        //$mform->addElement('static', 'username', get_string('username'), 'size="20"');
        if($user->id == -1)
		{
		...
		{
        $mform->addElement('text', 'username', get_string('username'),  array('size'=>'30', 'readonly'=>'true', 'disabled'=>'true'));
        //Add SALMA
        //$nomuser = get_string('username');
        //$username= $user->username;
       // echo "$mform->addElement $nomuser : $username<br>";
        //echo "$mform->addElement Prénom : $user->firstname<br>";
        //echo "$mform->addElement Nom : $user->lastname<br>";
        //echo "$mform->addElement Adresse de courriel : $user->email<br>";
        
        //$usernameelement = $mform->getElement('username');
        //$usernameelement->setValue($username);
        
        //Comment by SALMA (required)
        //$mform->addRule('username', $strrequired, 'required', null, 'client');
        $mform->setType('username', PARAM_RAW);
		}
