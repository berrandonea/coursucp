...
//SALMA visualiser les participants d'un cours (profil étudiant)
...
if (has_capability('moodle/course:viewhiddenuserfields', $context)) {
    ...
    // BRICE. $hiddenfields = array_flip(explode(',', $CFG->hiddenuserfields));
    $hiddenfields = array_flip(explode(',', $CFG->hiddenuserfields.',idnumber')); // BRICE.
}
...
if ($mode === MODE_BRIEF && !isset($hiddenfields['idnumber'])) {
    $tablecolumns[] = 'idnumber';
    $tableheaders[] = 'Numéro étudiant';
}
...
$userfields = array('username', 'email', 'city', 'country', 'idnumber', 'lang', 'timezone', 'maildisplay');
