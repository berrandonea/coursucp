...
foreach ($composantes as $composante) {
    ...
    $data3y = array_merge($data3y, array("$nbactivestudentsincomposante"));
    $count = $nbknownstudentsincomposante - $nbactivestudentsincomposante;
...
$b3plot->SetLegend("Étudiants actifs");
...
$graph->title->Set("Étudiants actifs");
